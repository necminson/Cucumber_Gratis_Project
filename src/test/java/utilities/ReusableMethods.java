...
//   waitFor(5);  => waits for 5 second
    ...
    public static WebElement selectRandomEntryFromList(List<WebElement> webList) {
               Random random = new Random();
               List<WebElement> listWeb= webList;
        int anyIndex = 1 + random.nextInt(listWeb.size()- 1);

        return listWeb.get(anyIndex);

             //listWeb.get(anyIndex);
    }
